...
class ServerSession:
    def __init__(self):
        ...
        if self.engine is None:
            raise RuntimeError("ServerSession engine initialization failed")
    ...
    def _get_engine(self):
        ...
        try:
            quoted = urllib.parse.quote(env.SNOWFLAKE_PASSWORD)
            url = URL(
            ...
            raise RuntimeError(f"Error creating Snowflake engine: {e}")
